 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see com.example.e4.todo.model.extensions.ExtensionsFactory
 * @model kind="package"
 * @generated
 */
public interface ExtensionsPackage extends EPackage {
   ...
   * @generated
   */
  String eNS_URI = "http://todo.e4.example.com/extensions";
   ...
   * @generated
   */
  ExtensionsPackage eINSTANCE = com.example.e4.todo.model.extensions.impl.ExtensionsPackageImpl.init();

  /**
   * The meta object id for the '{@link com.example.e4.todo.model.extensions.impl.MyOwnPartImpl <em>My Own Part</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see com.example.e4.todo.model.extensions.impl.MyOwnPartImpl
   * @see com.example.e4.todo.model.extensions.impl.ExtensionsPackageImpl#getMyOwnPart()
   * @generated
   */
  int MY_OWN_PART = 0;
  ...
  /**
   * The feature id for the '<em><b>My Extended Value</b></em>' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int MY_OWN_PART__MY_EXTENDED_VALUE = BasicPackageImpl.PART_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int MY_OWN_PART_FEATURE_COUNT = BasicPackageImpl.PART_FEATURE_COUNT + 1;

  /**
   * The meta object id for the '{@link com.example.e4.todo.model.extensions.impl.MyOwnPartStackImpl <em>My Own Part Stack</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see com.example.e4.todo.model.extensions.impl.MyOwnPartStackImpl
   * @see com.example.e4.todo.model.extensions.impl.ExtensionsPackageImpl#getMyOwnPartStack()
   * @generated
   */
  ...
  /**
   * The feature id for the '<em><b>Part Special</b></em>' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int MY_OWN_PART_STACK__PART_SPECIAL = BasicPackageImpl.PART_STACK_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int MY_OWN_PART_STACK_FEATURE_COUNT = BasicPackageImpl.PART_STACK_FEATURE_COUNT + 1;


  /**
   * Returns the meta object for class '{@link com.example.e4.todo.model.extensions.MyOwnPart <em>My Own Part</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>My Own Part</em>'.
   * @see com.example.e4.todo.model.extensions.MyOwnPart
   * @generated
   */
  EClass getMyOwnPart();

  /**
   * Returns the meta object for the attribute '{@link com.example.e4.todo.model.extensions.MyOwnPart#getMyExtendedValue <em>My Extended Value</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>My Extended Value</em>'.
   * @see com.example.e4.todo.model.extensions.MyOwnPart#getMyExtendedValue()
   * @see #getMyOwnPart()
   * @generated
   */
  EAttribute getMyOwnPart_MyExtendedValue();

  /**
   * Returns the meta object for class '{@link com.example.e4.todo.model.extensions.MyOwnPartStack <em>My Own Part Stack</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>My Own Part Stack</em>'.
   * @see com.example.e4.todo.model.extensions.MyOwnPartStack
   * @generated
   */
  EClass getMyOwnPartStack();

  /**
   * Returns the meta object for the attribute '{@link com.example.e4.todo.model.extensions.MyOwnPartStack#getPartSpecial <em>Part Special</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Part Special</em>'.
   * @see com.example.e4.todo.model.extensions.MyOwnPartStack#getPartSpecial()
   * @see #getMyOwnPartStack()
   * @generated
   */
  EAttribute getMyOwnPartStack_PartSpecial();
  ...
  interface Literals {
    /**
     * The meta object literal for the '{@link com.example.e4.todo.model.extensions.impl.MyOwnPartImpl <em>My Own Part</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see com.example.e4.todo.model.extensions.impl.MyOwnPartImpl
     * @see com.example.e4.todo.model.extensions.impl.ExtensionsPackageImpl#getMyOwnPart()
    ...
    /**
     * The meta object literal for the '<em><b>My Extended Value</b></em>' attribute feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EAttribute MY_OWN_PART__MY_EXTENDED_VALUE = eINSTANCE.getMyOwnPart_MyExtendedValue();

    /**
     * The meta object literal for the '{@link com.example.e4.todo.model.extensions.impl.MyOwnPartStackImpl <em>My Own Part Stack</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see com.example.e4.todo.model.extensions.impl.MyOwnPartStackImpl
     * @see com.example.e4.todo.model.extensions.impl.ExtensionsPackageImpl#getMyOwnPartStack()
    ...
    /**
     * The meta object literal for the '<em><b>Part Special</b></em>' attribute feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EAttribute MY_OWN_PART_STACK__PART_SPECIAL = eINSTANCE.getMyOwnPartStack_PartSpecial();
