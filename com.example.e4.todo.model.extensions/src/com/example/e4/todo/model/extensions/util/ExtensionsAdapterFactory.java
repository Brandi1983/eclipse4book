/**
 */
package com.example.e4.todo.model.extensions.util;
...
public class ExtensionsAdapterFactory extends AdapterFactoryImpl {
  ...
  /**
   * Creates a new adapter for an object of class '{@link com.example.e4.todo.model.extensions.MyOwnPart <em>My Own Part</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link com.example.e4.todo.model.extensions.MyOwnPartStack <em>My Own Part Stack</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
